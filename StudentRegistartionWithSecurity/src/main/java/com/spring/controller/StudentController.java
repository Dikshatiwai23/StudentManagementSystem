...
public class StudentController {
	...
	public String add_Student(Model m) {
	...
	public String saveStudent(@ModelAttribute("student") Student student) { // save student from the db;
	...
	public String update_form(@PathVariable(value = "id") long id, Model m) {
